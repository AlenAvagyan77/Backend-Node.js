...
import {RequestsManager} from "./RequestsManager"; // Ensure this path is correct and the class name matches the file name
...
export class WebSocketService {
    ...
    constructor(private userManager: UserManager, private requestManager: RequestsManager) {
    }
